...
""" KONFIGURASI SPARK DAN POSTGRES, PERSIAPAN DATA, DAN ANALISIS"""
# Preparation
...
## Membuat sesi Spark
spark = SparkSession.builder.appName("TugasDay15Analisis").getOrCreate()
...
""" MENYIMPAN HASIL DATA ANALISIS KE DATABASE"""
# Simpan ke Postgres
## Tabel target di PostgreSQL untuk hasil
target_table_name = "top_country_payments"
...
""" MENCOBA UNTUK MELIHAT TABEL DARI YANG BARU DIBUAT DI DATABASE"""
# Mencoba untuk menunjukan tabel yang telah di isi oleh data hasil analisis
## Tabel baru sumber data di PostgreSQL
table_name_baru = "top_country_payments"

## Membaca data dari PostgreSQL
df = spark.read.jdbc(url=jdbc_url, table=table_name_baru, properties=properties)
